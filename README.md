...
The dataset used is "Animals on the Web", prepared by Tamara Berg of UNC Chapel Hill     (http://tamaraberg.com/animalDataset/index.html), which contains Google Image Search results of various animals, including alligators, dolphins, ants etc. This dataset contains both negative and positive search results, but we shall only use the positive samples for our purpose. 
